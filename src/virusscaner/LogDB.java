 ...
 * @author ThomasBriggs
 */
public class LogDB extends javax.swing.JFrame {
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        if(jTable.getSelectedRow() == -1){
            ...
            int answer = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete a log?");
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        if(jTable.getSelectedRow() == -1){
            ...
            int answer = JOptionPane.showConfirmDialog(null, "Are you sure you want to edit a log?");
            if (answer == JOptionPane.YES_OPTION){
                editUser();
                try {
                    delRecord();
    ...
    public void editUser(){
        ...
        try {
            ...
            EditRecord.setLog(Integer.parseInt(fileData[index][0]), index);
    ...
    public void loadData() throws IOException{
        ...
        String[] cols = {"LogID", "Date and time", "Directory", "UserID"};
    ...
    public void delRecord() throws IOException{
        ...
        String[][] fileData = currentSort();
        int index = se.idSearch(fileData[selectedIndex][0], "log.txt");
        try {
            io.delRecord(io.read("log.txt"), index, "log.txt");
            currentSort();
            loadData();
        } catch (IOException ex) {
            Logger.getLogger(LogDB.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String[][] currentSort() throws IOException{
        ...
        if(selected == 0){
            output = sort.bubbleSort2dArray("log.txt", 0, 4);
        }else if(selected == 1){
            output = sort.bubbleSort2dArray("log.txt", 0, 4, true);
        }
        return output;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogDB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
