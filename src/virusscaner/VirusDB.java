 ...
 * @author ThomasBriggs
 */
public class VirusDB extends javax.swing.JFrame {
    ...
    sortCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Virus ID Low - High", "Virus ID High - Low", "User ID Low - High", "User ID High - Low" }));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        try {
            ...
            Logger.getLogger(VirusDB.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void delBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delBtnActionPerformed
        ...
        if(jTable.getSelectedRow() == -1){
            ...
            int answer = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete a virus signature?");
    ...
    public void loadData() throws IOException{
        ...
        String[] cols = {"VirusID", "Hash", "UserID"};
    ...
    public void delRecord() throws IOException{
        ...
        int index = se.idSearch(fileData[selectedIndex][0], "VirusDB.txt");
        try {
            io.delRecord(io.read("VirusDB.txt"), index, "VirusDB.txt");
            sort.bubbleSort2dArraySave("VirusDB.txt", 0, 3);
            loadData();
        } catch (IOException ex) {
            Logger.getLogger(VirusDB.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public String[][] currentSort() throws IOException{
        ...
        if(selected == 0){
            output = sort.bubbleSort2dArray("VirusDB.txt", 0, 3);
        }else if(selected == 1){
            output = sort.bubbleSort2dArray("VirusDB.txt", 0, 3, true);
        }else if(selected == 2){
            output = sort.bubbleSort2dArray("VirusDB.txt", 2, 3);
        }else if(selected == 3){
            output = sort.bubbleSort2dArray("VirusDB.txt", 2, 3, true);
        }
        return output;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VirusDB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
